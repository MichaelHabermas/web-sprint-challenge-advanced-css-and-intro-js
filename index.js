export const artists = [
	{
		...
		paintings: 193,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/8/break/images-medium/young-brunette-modigliani.jpg'
	},
	{
		id: 1,
		...
		paintings: 88,
		image:
			'https://upload.wikimedia.org/wikipedia/commons/8/8b/Vassily_Kandinsky%2C_1909_-_Murnau_train_et_ch%C3%A2teau.jpg'
	},
	{
		id: 2,
		name: 'Diego Rivera',
		...
		paintings: 70,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/8/break/images/artworkimages/medium/3/flower-seller-rivera-diego-rivera.jpg'
	},
	{
		id: 3,
		name: 'Claude Monet',
		...
		paintings: 73,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/7.5/break/images/artworkimages/medium/1/the-japanese-bridge-claude-monet-.jpg'
	},
	{
		id: 4,
		name: 'Rene Magritte',
		...
		paintings: 194,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/5.5/break/images/artworkimages/medium/1/a-riff-on-magrittes-the-pilgrim-scott-norris.jpg'
	},
	{
		id: 5,
		name: 'Salvador Dali',
		...
		paintings: 139,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/6/break/images/artworkimages/medium/3/dolly-in-dali-land-james-w-johnson.jpg'
	},
	{
		id: 6,
		name: 'Edouard Manet',
		...
		paintings: 90,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/6/break/images/artworkimages/medium/1/1-a-bar-at-the-folies-bergere-edouard-manet.jpg'
	},
	{
		id: 7,
		name: 'Andrei Rublev',
		...
		paintings: 99,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/6/break/images-medium-5/film-homage-andrei-tarkovsky-andrei-rublev-1966-wall-coolidge-arizona-2004-david-lee-guss.jpg'
	},
	{
		id: 8,
	...
	},
	{
		...
		paintings: 117,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/4.5/break/images/artworkimages/medium/1/the-tree-of-life-gustav-klimt.jpg'
	},
	{
		id: 10,
		...
		paintings: 137,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/4.5/break/images-medium-5/2-the-garden-of-earthly-delights-hieronymus-bosch.jpg'
	},
	{
		id: 11,
		...
		paintings: 126,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/6.5/break/images/artworkimages/medium/1/the-sportsmen-kazimir-malevich.jpg'
	},
	{
		id: 12,
		name: 'Mikhail Vrubel',
		...
		paintings: 171,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/4.5/break/images/artworkimages/medium/2/the-demon-seated-mikhail-vrubel.jpg'
	},
	{
		id: 13,
		name: 'Pablo Picasso',
		...
		paintings: 439,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/6/break/images/artworkimages/medium/3/pablos-last-concert-otto-rapp.jpg'
	},
	{
		id: 14,
		...
		paintings: 141,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/5.5/break/images-medium-5/1-daniel-in-the-lions-den-peter-paul-rubens.jpg'
	},
	{
		id: 15,
		...
		paintings: 336,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/6/break/images/artworkimages/medium/1/the-luncheon-of-the-boating-party-pierre-auguste-renoir.jpg'
	},
	{
		id: 16,
		name: 'Francisco Goya',
		...
		paintings: 291,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/6/break/images/artworkimages/medium/1/execution-of-the-defenders-of-madrid-goya.jpg'
	},
	{
		id: 17,
		name: 'Frida Kahlo',
		...
		paintings: 120,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/8/break/images-medium-5/frida-kahlo-with-flowers-and-skull-lulu-mypinkturtle.jpg'
	},
	{
		id: 18,
		name: 'El Greco',
		...
		paintings: 87,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/6.5/break/images/artworkimages/medium/1/4-christ-healing-the-blind-el-greco.jpg'
	},
	{
		id: 19,
		name: 'Albrecht Dürer',
		...
		paintings: 328,
		image:
			'https://render.fineartamerica.com/images/rendered/default/print/8/5.5/break/images/artworkimages/medium/1/pond-in-the-woods-albrecht-drer-eloisa-mannion.jpg'
	}
];
...
function get20s(array) {
	...
	for (let i = 0; i < array.length; i++) {
		let duration = array[i].years.split(' - ');
		if (duration[0] >= 1900 && duration[0] <= 2000) {
...
function addArtist(array) {
	array.push({
		...
		bio: `Just a man, standing in front of a woman, here to say 'Hey, Who's Hungry? In-and-Out Burger just opened up let's go.'`
	});
	return array;
}
...
// src="//upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Vincent_van_Gogh_-_Self-Portrait_-_Google_Art_Project.jpg/220px-Vincent_van_Gogh_-_Self-Portrait_-_Google_Art_Project.jpg"
...
function getHTML(data) {
	for (const element in data) {
		console.log(
			`<div id="artist">
			<div class="image">
				<img src="${data[element].image}" alt="artist painting"/>
			</div>
			<div class="name">
				<a href="${data[element].wikipedia}">${data[element].name}</a>
			</div>
			<div class="bio">
				${data[element].bio}
			</div>
...
// artistContainer.appendChild(getHTML(artists));
// console.log(artistContainer);
...
function randomize(array) {
	...
	while (length > 0) {
		//finda a random place in the array
		randoPos = Math.floor(Math.random() * array.length);
		// switches a random position with one of each of the arrasy's index, starting from the last moving backwards
		[array[length], array[randoPos]] = [array[randoPos], array[length]];
		length--;
	}
	return array;
}
